...
class SearchEngine:
    ...
    def search(self, query_text: str, 
        ...
        if self.bm25_index is None:
            raise ValueError("No index loaded. Call load_bm25_index() first.")
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Search BM25 index for legal acts",
...
Examples:
  ...
  # Single query
  python -m index.search --index ./indexes/act1 --query "základní pojmy"
  ...
  python -m index.search --index ./indexes/act1 --query "povinnosti" --pattern "^§"
    ...
    try:
        ...
        search_engine.load_bm25_index(args.index)
